      ...
      <section id='Content' className='pt-5'>
        <div className="row p-lg-5 p-sm-3">
          <div className="col-lg-6 px-md-5 px-sm-0 my-auto">
            <p className='para1 px-2' style={{textAlign:"justify"}}>DevFlux thrives not just by providing outstanding quality of service to our customers, but also from atracting the best and brightest young talent</p>
          ...
          <div className="col-lg-6">
            <img src={two} alt="image1" className='img-fluid d-flex mx-auto rounded px-2' />
          </div>
        </div>
        <div className="row p-lg-5 p-sm-3">
          <div className="col-lg-6 order-2 order-lg-1">
            <img src={four} alt="image1" className='img-fluid d-flex mx-auto rounded px-2' />
          </div>
